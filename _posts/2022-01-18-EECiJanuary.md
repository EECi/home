...
{% include figure image_path="/Images/EECinsights/EECi_January_Hex.png" alt="Hexmap of North-East of England showing energy intensity for each type of house over time." %}
...
{% include figure image_path="/Images/EECinsights/EECi_January_Lolly.png" alt="Lollipop chart showing the difference between post-2000 and pre-1930 semi-detached houses" %}
