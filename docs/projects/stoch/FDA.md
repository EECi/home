...
{% include figure image_path="/Images/stoch/CompEngSgCaChUS_2.svg" alt="Typical office plug load schedules" caption="Typical office plug load schedules" width="200" height="400" %}
