...
{% include figure image_path="/Images/ssenv/gif4Presentation_v9_C0_RH_RB_H_highTBase_khrev_rotation_xslice.gif" alt="Subsurface temperature variations below Cardiff city centre" %}
